  ...
  return (
    <div className="min-h-screen bg-obsidian-500 overflow-x-hidden">
      ...
      <section className="relative min-h-[100vh] flex items-center overflow-hidden">
        ...
        >
          <img
            src="./src/public/images/foto1.jpg"
      ...
      <section id="about" className="section-padding relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="./src/public/images/foto3.jpg"
            ...
            <AnimatedSection delay={200} className="relative">
              <div className="relative">
                <div className="aspect-[4/5] rounded-sm overflow-hidden shadow-luxury-xl">
                  <img
                    src="./src/public/images/foto8.jpg"
      ...
      <section id="services" className="section-padding relative">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="./src/public/images/foto6.jpg"
            ...
            {[
              {
                ...
                image: "./src/public/images/foto21.jpg",
              },
              {
                icon: Hammer,
                ...
                image: "./src/public/images/foto16.jpg",
              },
              {
                icon: Palette,
                ...
                image: "./src/public/images/foto12.jpg",
              },
            ].map((service, index) => (
      ...
      <section className="section-padding overflow-hidden relative">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="./src/public/images/foto13.jpg"
              ...
              {[
                {
                  ...
                  icon: Users,
                  image: "./src/public/images/foto17.jpg",
                },
                {
                  step: '02',
                  ...
                  icon: Target,
                  image: "./src/public/images/foto19.jpg",
                },
                {
                  step: '03',
                  ...
                  icon: Palette,
                  image: "./src/public/images/foto6.jpg",
                },
                {
                  step: '04',
                  ...
                  icon: Shield,
                  image: "./src/public/images/foto25.jpg",
                },
                {
                  step: '05',
                  title: 'Construction',
                ...
                },
                {
                  ...
                  icon: Award,
                  image: "./src/public/images/foto20.jpg",
                },
              ].map((item, index) => (
                <AnimatedSection key={index} delay={index * 100}>
      ...
      <section id="portfolio" className="section-padding relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="./src/public/images/foto10.jpg"
            ...
            {[
              {
                ...
                location: 'Jepara',
                image: "./src/public/images/foto5.jpg",
              },
              {
                title: 'Nglimut House',
                category: 'Contemporary Villa',
                location: 'Semarang',
                image: "./src/public/images/foto22.jpg",
              },
              {
                title: 'Executive Office Premier',
                category: 'Commercial Building',
                location: 'Canggu',
                image: "./src/public/images/foto9.jpg",
              },
              {
                title: 'Bayfront Villa',
                category: 'Villa & Resort',
                location: 'Balikpapan',
                image: "./src/public/images/foto13.jpg",
              },
              {
                title: 'Artisan Restaurant',
                category: 'F&B Space',
                location: 'Tuban',
                image: "./src/public/images/nama-foto11.jpg",
              },
              {
                title: 'Grand Kitchen Suite',
                category: 'Interior & Furniture',
                location: 'Balikpapan',
                image: "./src/public/images/foto7.jpg",
              },
            ].map((project, index) => (
              <AnimatedSection key={index} delay={index * 100}>
      ...
      <section id="contact" className="section-padding relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="./src/public/images/foto2.jpg"
